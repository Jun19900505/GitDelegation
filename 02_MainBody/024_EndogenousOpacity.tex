...
This section analyzes endogenous opacity by allowing the manager to control $\omega_{e}$. We find that she strategically chooses opacity as a commitment device to restrict herself from taking excessive risk. 

\subsection{Setup} \label{sec:setupEndog}
Before the fund manager decides on the investment strategy in the fundraising stage ($t=0$), she chooses the fund opacity by controling $\omega_{e}$. 
