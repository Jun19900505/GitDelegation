...
\begin{enumerate}[label=(\roman*)]
	...
	\item If $\theta> \theta_{0}$, there are two thresholds of fund opacity, $\omega_{L}$ and $\omega_{H}(>\omega_{L})$. When $\omega_{e}\leq \omega_{L}$, the high-$\beta$ equilibrium is unique; when $\omega_{e}\ge\omega_{H}$, the low-$\beta$ equilibrium is unique; and when $\omega_{e}\in(\omega_{L},\omega_{H})$, the high- and low-$\beta$ equilibria coexist.
\end{enumerate}
\end{proposition}
...
\caption*{\footnotesize{Note: The figure plots the manager's expected fee income at the low-$\beta$ equilibrium (solid line) and high-$\beta$ equilibrium (dashed line) for different levels of skill, $|s|$. The parameter values used in the figures are $\omega_{s}=1$, $\omega_{u}=2$, $\omega_{e}=38$, and $\phi=0.02$.}}\label{fig:wageSens}
\end{figure}
...
\caption*{\footnotesize{Note: The figure plots the expected trading profit $\mathrm{E}[\pi]$ at the low-$\beta$ equilibrium (solid line) and the high-$\beta$ equilibrium (dashed line) for different levels of skill $|s|$. The parameter values used in the figure are $\omega_{s}=1$, $\omega_{u}=2$, $\omega_{e}=38$, and $\phi=0.02$.}}
\label{fig:perf}
\end{figure}
