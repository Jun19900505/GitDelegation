...
The fund's payoff from the risky investment is $\delta x$, while it allocates $M-px$ to the risk-free asset. Hence, by denoting the return from the risky investment by $\pi=(\delta -p) x$, the total fund proceeds are represented as
\begin{equation}
    y=\pi+M.
\end{equation}
