...
\end{definition}
Following Definition \ref{def:defl}, $8h>1$ and $\theta<\tilde{\theta}$ always lead to a unique low-$\beta$ equilibrium. In contrast, if $8h>1$ and $\theta\ge\tilde{\theta}$, then we have the following result:
\begin{lemma}
